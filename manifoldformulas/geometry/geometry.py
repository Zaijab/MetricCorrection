...
class Geometry(object):
    ...
    **kwargs :
    ...
    def compute_adjacency_matrix(self, copy=False, **kwargs):
        ...
        Parameters
        ----------
        copy : boolean, to return a copied version of the adjacency matrix
    ...
    def set_adjacency_matrix(self, adjacency_mat):
        ...
        """
        adjacency_mat = check_array(
            adjacency_mat, accept_sparse=sparse_formats)
    ...
    def set_laplacian_matrix(self, laplacian_mat):
        ...
        """
        laplacian_mat = check_array(
            laplacian_mat, accept_sparse=sparse_formats)
